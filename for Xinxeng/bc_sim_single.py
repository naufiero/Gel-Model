...
cytod_surf = meshio.read("larger_sphere" + ".msh")
cytod_faces = []
...
cytod_vol = meshio.read("bounding_box" + ".msh")

mesh = Mesh()
with XDMFFile("bounding_box" + ".xdmf") as infile:
    infile.read(mesh)
...
vert_disp = pd.read_csv("displacements_only.csv",
                        header=None).values
